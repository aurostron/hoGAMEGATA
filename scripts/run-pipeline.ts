...
const STAGES: Stage[] = [
  ...
  {
    name: "GOG Ingestion",
    script: "scripts/ingest-gog.ts",
    description: "Ingest and sync horror games from GOG Catalog",
    defaultLimit: 100
  },
  {
    name: "Steam Ingestion",
    script: "scripts/ingest-steam.ts",
    description: "Ingest and sync horror games from Steam Storefront Search",
    defaultLimit: 100
  },
  {
    name: "Mood Tagging",
