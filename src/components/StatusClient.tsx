...
export default function StatusClient() {
  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-white selection:text-black pb-24 relative overflow-hidden flex flex-col">
      ...
      <main className="max-w-3xl w-full mx-auto px-6 mt-12 space-y-8 relative z-10 flex-grow">
